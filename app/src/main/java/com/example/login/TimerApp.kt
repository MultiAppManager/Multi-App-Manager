...
import com.example.login.databinding.ActivityTimerAppBinding
import java.util.*

class TimerApp : AppCompatActivity()
{
    lateinit var binding: ActivityTimerAppBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        binding = ActivityTimerAppBinding.inflate(layoutInflater)
